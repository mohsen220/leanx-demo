...
import { BankIcon, PlusIcon, UserIcon, LogoutIcon } from '../icons.jsx';
...
// The balance shown below is Falcon's own (Falcon's ledger, backend/src/db.js),
// entirely separate from the pooled Lean X wallet Falcon funds behind the scenes.
  ...
  return (
    <div className="phone-screen">
      ...
      <div className="balance-card">
        <div>
          <div className="label">Your {brand.shortName} balance</div>
          <div className="amount">
            {fmt(sender.balance)} <small>{brand.homeCurrency}</small>
          </div>
        </div>
